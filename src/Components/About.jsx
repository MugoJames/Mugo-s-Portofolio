  ...
  return (
    <div className='p-8 text-white bg-eerie-black-2'>
      ...
      <div className='p-4 '>
        ...
        <p className='text-start mx-auto lg:pr-80 text-[16px] text-light-gray p-4 font-normal'>
        ...
        <p className='pt-4 lg:pr-80 text-[16px] text-light-gray p-4 font-normal'>
      ...
      <div className='text-light-gray p-4'>
        <h2 className='text-[23px] text-white mb-5'>🚀 What I Do!</h2>
        <ul className='grid lg:grid-cols-3 gap-[20px]'>
          <li className='bg-bg-gradient-jet shadow-shadow-2 relative rounded-[14px] p-[20px] flex z-1 border border-jet '>
